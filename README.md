...
![Database](https://github.com/emiruzun0/ChatApp/blob/main/img/database.png)

After press "Send" button, the message object will be created and send to the database
